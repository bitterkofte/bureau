...
const Footer = () => {
  ...
  return (
    ...
    <footer className="w-full bg-lp-brown dark:bg-lp-brown-darker text-slate-200">
      <div
        className="px-16 py-10 lg:px-48 lg:py-20 flex flex-col items-center lg:flex-row lg:items-start gap-8 lg:gap-24 text-intro"
        ref={introRef}
      >
        {/* PIN 1st GRP */}
        ...
        {/* PIN 2nd GRP */}
        <div className="flex flex-col lg:flex-row justify-between grow gap-16">
          {/* SECTION 2nd Col */}
